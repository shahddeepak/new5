...
<html lang="en">
   ...
   <body>
      ...
      <form class="row g-3" method="post" action="<?=base_url();?>Admin/userUpdate/<?=$data[0]['id'];?>">
         <div class="col-md-4">
            <label for="validationCustom01" class="form-label">Full Name</label>
            <input type="text" class="form-control" id="user_name" name="user_name" value="<?=$data[0]['user_name'];?>">
         </div>
         <div class="col-md-4">
            <label for="validationCustom02" class="form-label">Email</label>
            <input type="email" class="form-control" id="user_email" name="user_email" value="<?=$data[0]['user_email'];?>">
         </div>
         <div class="col-md-4">
